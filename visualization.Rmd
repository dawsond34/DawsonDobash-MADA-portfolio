...
Most of the visual looks roughly the same except the size of the charts (I tried to use the patchwork package but the legend for the fill variables were going in the wrong position under the individual titles. I went back to ggarange and tried to change the sizes as much as possible. 