...
joint_plot = ggarrange(plot1, plot4, plot3, plot5, plot2,ncol=3, nrow=2, common.legend = TRUE, legend="top", widths = c(2,2,1.4), heights = c(4.1,4) )
...
Most of the visual looks roughly the same except the size of the charts (I dont know exactly how to change the size of the figures).
