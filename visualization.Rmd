...
joint_plot = ggarrange(plot1, plot4, plot3, plot5, plot2,ncol=3, nrow=2, common.legend = TRUE, legend="top", widths = c(1.9,2,1.7), heights = c(4,4.1) )
...
Most of the visual looks roughly the same except the size of the charts (I tried to use the patchwork package but the legend for the fill variables were going in the wrong position under the individual titles. I went back to ggarange and tried to change the sizes as much as possible. Again, if there is any suggestions on the sizing of the figures using ggarrange, please let me know. 